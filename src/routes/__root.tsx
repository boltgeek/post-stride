...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PostPilot — Ton assistant contenu" },
      ...
      { name: "twitter:title", content: "PostPilot — Ton assistant contenu" },
      ...
      { name: "apple-mobile-web-app-title", content: "PostPilot" },
    ],
    links: [
